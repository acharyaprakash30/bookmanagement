...
import BookService from '../../../assests/img001.png'
...
const Login = () => {
    ...
    return (
        <section className='w-screen  justify-center align-middle  min-h-screen relative overflow-hidden flex  py-10 sm:py-8'>
            {
                loading && (
                    <MainLoader />
                )
            ...
            <aside className='flex flex-col  shadow-md items-center w-[90%] backdrop-filter  z-10 sm:w-460 backdrop-blur-3xl p-4 px-4  bg-opacity-20 lg:bg-opacity-100'>
                ...
                <h3 className="text-black font-semibold text-3xl mt-5">Welcome Back!</h3>
                <h6 className='text-xl text-lighttextGray mb-4 mt-1 font-semibold'>Login with following</h6>
