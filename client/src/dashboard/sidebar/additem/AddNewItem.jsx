...
const initialValues = { title: '', category: '',author:'', description:'', price: '', file: null };
            ...
            <aside className='border border-purple-200 shadow-xl rounded-md p-4 w-full flex flex-col items-center  justify-center gap-4 py-6 pb-10'>
                ...
                <div className='w-full flex gap-4'>
                    ...
                    <aside className='w-2/6'>
                        <motion.input type="text" {...slideTop} placeholder='Enter Book name' className='w-full px-4 py-3 bg-gray-100 font-semibold   shadow-md outline-none rounded-md border border-gray-300 focus:border-red-400' onBlur={handleBlur}
                            onChange={handleChange} name='title' value={values.title} />
                        {touched.title && errors.title && <motion.div {...fadeInOut} className='pt-2 px-2 text-red-500'>{errors.title}</motion.div>}
                    </aside>
                    <aside className='w-2/6'>
                        <motion.input type="text" {...slideTop} placeholder='Enter Author name' className='w-full px-4 py-3 bg-gray-100 font-semibold   shadow-md outline-none rounded-md border border-gray-300 focus:border-red-400' onBlur={handleBlur}
                            onChange={handleChange} name='author' value={values.author} />
                        {touched.author && errors.author && <motion.div {...fadeInOut} className='pt-2 px-2 text-red-500'>{errors.author}</motion.div>}
                    </aside>

                    <aside className='w-2/6 relative'>
                        <motion.input {...slideTop} type="number" placeholder='Enter Book Price' className='w-full px-10 py-3 bg-gray-100  shadow-md outline-none rounded-md border border-gray-300 focus:border-red-400 font-semibold' onBlur={handleBlur}
                ...
                <aside className='w-full relative'>
                        <motion.textarea {...slideTop} type="text" placeholder='Description of book' className='w-full px-10 py-3 bg-gray-100  shadow-md outline-none rounded-md border border-gray-300 focus:border-red-400 font-semibold' onBlur={handleBlur}
                            onChange={handleChange} name='description' value={values.description} />
                        {touched.description && errors.description && <motion.div {...fadeInOut} className='pt-2 px-2 text-red-500'>{errors.description}</motion.div>}
                    </aside>
                </div>
             

                <section className='flex w-full mt-4 px-3'>
