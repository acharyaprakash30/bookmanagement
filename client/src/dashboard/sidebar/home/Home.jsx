    ...
    return (
        <section className=' pt-10 pb-8 '>
            ...
            <aside className='w-full flex justify-evenly py-5' >
                ...
                <Card title="Books" count={itemStats?.totalItems} latest={itemStats?.latestItemCount} per={itemStats?.percentage}
                    icon={<MdLibraryBooks size={37} />} style='bg-[rgb(58,203,232)]' />
            ...
            <aside className=' w-full mt-20  flex justify-between'>
                ...
                <section className='flex  relative pt-5'>
                    <p className='text-gray-200 text-2xl absolute top-0 font-semibold left-0 -mt-6 px-3 py-1 shadow-lg bg-orange-600 rounded-lg'>Books Category</p>
                    <aside className='flex flex-col gap-1 mt-3'>
                        <div className='flex gap-2'> <p className='w-5 h-5 rounded-full  bg-[rgb(255,99,132)]'></p>Fiction</div>
                        <div className='flex gap-2'> <p className='w-5 h-5 rounded-full  bg-[#36A2EB]'></p>Non-Fiction</div>
                        <div className='flex gap-2'> <p className='w-5 h-5 rounded-full  bg-[#FFCE56]'></p>Novel</div>
                        <div className='flex gap-2'> <p className='w-5 h-5 rounded-full  bg-[#8E44AD]'></p>Romance</div>
                    </aside>
