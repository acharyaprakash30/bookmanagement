...
const EditItem = ({ hideEditModal, selectItem }) => {
    ...
    const initialValues = { title: selectItem.title, author: selectItem.author, description:selectItem.description, category: selectItem.category, price: selectItem.price, file: selectItem.image };
