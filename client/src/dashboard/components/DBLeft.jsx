    ...
    return (
        <section className='h-full bg-gradient-to-r from-gray-100 to-gray-300 py-12 hidden md:flex flex-col backdrop-blur-md shadow-md min-w-210 w-300 gap-3 px-[11px] '>
            ...
            <NavLink to='/' className='flex items justify-start gap-4 items-center text-2xl'>
                ...
                <h4 className='font-semibold text-2xl '>Book Store.</h4>
            </NavLink>
            ...
            <ul className='flex flex-col gap-4' >
                ...
                <NavLink className={({ isActive }) => isActive ? `${isActiveStyles} px-4 py-2 border-l-8 border-red-500` : isNotActiveStyles} to={'/dashboard/items'}>Books</NavLink>
                <NavLink className={({ isActive }) => isActive ? `${isActiveStyles} px-4 py-2 border-l-8 border-red-500` : isNotActiveStyles} to={'/dashboard/addnewbooks'}>Add New Book</NavLink>
